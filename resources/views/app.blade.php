...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-gray-100 dark:bg-gray-900 dark:text-gray-100">
    ...
    <body class="font-sans antialiased bg-gray-100 dark:bg-gray-900 dark:text-gray-100 min-h-screen">
        <!-- Loading Animation -->
        <div id="loading-spinner" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 9999;" class="bg-gray-100 bg-opacity-80 dark:bg-gray-900 dark:bg-opacity-80">
            <svg class="animate-spin -ml-1 mr-3 h-10 w-10 text-gray-600 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
